...
class PDA(Generic[ET]):  # Probabilistic Data Association
    ...
    def gate(
        ...
        *,
        ...
        """
        gated = [
            self.state_filter.gate(Z[i,:], filter_state, g_squared, sensor_state=sensor_state) for i in range(M)
        ]
        return gated
    ...
    def loglikelihood_ratios(
        ...
        *,
        ...
        ] #: some for loop over elements of Z using self.state_filter.loglikelihood
